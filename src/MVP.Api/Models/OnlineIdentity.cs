namespace MVP.Api.Models
{
    ...
    {
        [JsonProperty("OnlineIdentityId")] public Guid? Id { get; set; }

        [JsonProperty("MvpGuid")] public Guid? MvpId { get; set; }
        ...
        [JsonProperty("MicrosoftAccount")] public string MicrosoftAccount { get; set; }

        [JsonProperty("ContributionCollected")]
        public bool? ContributionCollected { get; set; }

        [JsonProperty("PrivacyConsentStatus")] public bool? PrivacyConsentStatus { get; set; }
